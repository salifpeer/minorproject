...
//   mysqli_select_db($con,'reports');
   ...
   if(isset($_POST['update']))
      ...
      $testTypes=$_POST['testTypes'];
  	 ...
  	 $uploadBy='Admin '.$res['firstName']." ".$res['lastName'].' And id = '.$res['id'];
...
<body>
	...
	<div id='reportOuter' class="bg-dark">
 ...
 ?>
   ...
   <?php 
    ...
    ?>  
			...
			<br><input type="submit" name="update" class="btn btn-danger text-white btnAdd" value="Add Report">
      </form>
  </div>
</body>
</html>
