...
<form method="POST">
    ...
    <div class="searchFilter">
     ...
     <input type="submit" class="btn btn-danger searchBtn" name="searchBtn" value="Search">
    </div>
 ...
 <select class='form-control filters bar' name='filters'>
     ...
     <input type="submit" class="btn btn-danger searchBtn" name="filter" value="Sort">
</div>
...
Add <span>Patient</span></h1><br>
 ...
 <small style="position: relative;bottom: 10px;left: 20px;color: red;"></small><br><br>
  ...
  <button type="submit" name="next" class="btn btn-danger text-white nextBtn" onclick="return validate()" >Next</button>
		</form>		
