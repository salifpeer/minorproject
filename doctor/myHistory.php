<?php 
 ...
 <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
  ...
  <li class="nav-item" role="presentation">
    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">My Appointments</a>
  </li>
</ul>
...
<div class="tab-content" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    ...
    <div class="prescription"><br><br>
     ...
     <h1 style="color: #08f;" class="text-center view"><i  class="fa fa-wheelchair" aria-hidden="true"></i>&nbspPres<span style="color: white;">cription</span> </h1><br>
...
<!-- .......................Appointments..................................... -->
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
    <div id="outer"><br><br>
     ...
     <h1 style="color: #08f;" class="text-center view"><i class="fa fa-wheelchair" aria-hidden="true"></i>&nbspAppoint<span style="color: white;">ments</span> </h1><br>
...
?>
           <tr class="text-center">
              ...
              <td><button class="btn btn-success historyBtn"><a href="prescription.php?id=<?php echo $resAppointment['patientId']; ?>" class="text-white">Add Prescription</a></button> </td>
           </tr>
 ...
 <script type="text/javascript">
  ...
  function toggle()
  {
    ...
    { 
      ...
      document.getElementById('cover').style="margin-left:259px;";
