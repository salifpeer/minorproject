<?php 
 ...
 <body>
 	...
 	<div id="cover" class="text-white">
 		...
 		<!-- ....................................head division............................... -->
	 				...
	 				<h4 id="signup">Doctor's <span>Sign Up</span></h4>
 ...
 <i  style="position: relative;left: 27px; color:#f36;" class="fa fa-user-circle" aria-hidden="true"></i></i>
 <input type="text" name="username" placeholder="Username" onkeypress="valUsername()" id="valusername" required="" autocomplete="off"  >
 <small id="userSmall" style="color: #223;font-size: 10px;">.</small><br>


 <i  style="position: relative;left: 27px; color:#f36;" class="fa fa-envelope" aria-hidden="true"></i>
 ...
 <small style="position: relative;bottom: 10px;left: 20px;color: red;"></small><br><br>
  ...
  <button type="submit" name="next" class="btn btn-info nextBtn" onclick="return validate()">Next</button>
    ...
    $checkEmail="select * from doctors where email='$email'";
     ...
     if ($totalUsername>0) 
  	...
  	else
  	{
  		...
  		$q="INSERT INTO `doctors`(`username`,`email`) VALUES ('$username','$email')";
...
<br>
		<h6 class="text-center">Already have an Account <a href="login.php">Click Here</a></h6>
	 	</div>
