...
<body>
	 ...
	 <div id="profile">
	 	...
	 	<div id="dpinside" ></div>
	 		...
	 		<h3 id="post"><?php echo $res['speciality']; ?></h3><br><br>
	 		...
	 		<div class="info patients"><h4>Total Patients prescribed</h4> <i class="fa fa-wheelchair" aria-hidden="true"></i><br><br><br>
	 			<?php
