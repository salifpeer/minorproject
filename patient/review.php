...
<body >
	...
	<div id="">
		  ...
		  <div  style="margin-left: 18%; margin-top: 10%; width: 50%">
       ...
       <?php
           ...
           if(isset($_POST['btn']))
           {
              ...
              $con=mysqli_connect("localhost","root","","d-care");
              mysqli_query($con, "insert into p_reviews (rating,review,user_id) values ('".$_POST['rating']."', '".$_POST['review']."', '".$_SESSION['patient-id']."')");
