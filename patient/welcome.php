	...
	<div id="welcome">
	 ...
	 <div id="profile">
	 	...
	 	<div id="dpinside" ></div>
	 		...
	 		<h1 id="name1"><?php echo $res['firstName']; ?> <span class="text-warning"><?php echo $res['lastName']; ?></span></h1>
	 		...
	 		<div class="info patients"><h4>Total Appointments Taken</h4> <i class="fa fa-wheelchair" aria-hidden="true"></i><br><br><br>
	 			<?php

    			$sql="SELECT COUNT(doctorId) AS total FROM prescription WHERE doctorID='$id'";
    			$result=mysqli_query($con,$sql);
    			$values=mysqli_fetch_assoc($result);
    			$num_rows=$values['total'];
    			echo '<h2 class="text-white">'.$num_rows.'<h2>';
				?>
			</div>
